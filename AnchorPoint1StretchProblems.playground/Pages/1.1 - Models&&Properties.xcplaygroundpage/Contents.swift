...
♦ Black Diamond
Create a function that will print out a description of a person's favorite things, or say that the person doesn't like anything. This function should work properly whether or not the optional properties were set. Example printouts below:Example 1: "John's favorite color is blue."
